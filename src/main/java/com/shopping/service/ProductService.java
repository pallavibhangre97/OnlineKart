...
public class ProductService {
	...
	public List<Product> getAllProducts(){
		...
		products.add(new Product(100,"Book1",200,"C++ book","ffd","dfdf"));
		products.add(new Product(101,"Book2",300,"C++ book","ffd","dfdf"));
		products.add(new Product(102,"Book3",600,"C++ book","ffd","dfdf"));
		products.add(new Product(103,"Book4",24500,"C++ book","ffd","dfdf"));
		products.add(new Product(104,"Book5",2070,"C++ book","ffd","dfdf"));
		return products;
	}

	// Method to get all products available
	/* todo : uncomment this and comment method getAllProducts
